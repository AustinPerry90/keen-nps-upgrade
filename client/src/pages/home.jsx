...
const Home = () => {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {/* Bottom section - Latest Surveys */}
      {latestSurveys.length > 0 && (
        <div className="bg-white shadow-md rounded-xl p-4">
          <h3 className="text-lg font-semibold mb-4">Latest Surveys</h3>

          {/* Survey limit buttons */}
          <div className="mb-4 space-x-2">
            {[5, 10, 25, 50].map(limit => (
              <button
                key={limit}
                onClick={() => setSurveyLimit(limit)}
